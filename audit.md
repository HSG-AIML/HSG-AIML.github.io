...
* M. Schreyer, T. Sattarov, C. Schulze, B. Reimer, and D. Borth, **"Detection of Accounting Anomalies in the Latent Space using Adversarial Autoencoder Neural Networks"**, ACM KDD Workshop on Anomaly Detection in Finance, Anchorage, Alaska, USA, 2019.
