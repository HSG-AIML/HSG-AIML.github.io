...
description="The adversarial autoencoder architecture, applied to learn a disentan-gled and human interpretable representation of the journal entries generative latent factors." %}
